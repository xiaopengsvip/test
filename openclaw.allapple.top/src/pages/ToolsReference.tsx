            ...
            <ul className="space-y-4">
              {configLocations.map((loc, idx) => (
                <li key={idx} className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-slate-700 dark:text-slate-300">
                  ...
                  <code className="px-3 py-1.5 bg-slate-100 dark:bg-black/30 rounded-lg text-sm font-mono text-indigo-600 dark:text-indigo-400 break-all border border-slate-200 dark:border-white/10">
                    {loc.path}
                  </code>
                </li>
              ))}

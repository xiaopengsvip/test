  ...
  return (
    <div className="relative group mt-3 mb-5">
      <div className="absolute right-2 top-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
        <button
          onClick={handleCopy}
          className="p-1.5 glass-button text-slate-600 dark:text-slate-300 rounded-md transition-colors"
          title="复制代码"
        >
          {copied ? <Check className="w-4 h-4 text-emerald-400" /> : <Copy className="w-4 h-4" />}
        </button>
      </div>
      <pre className="glass-panel text-slate-800 dark:text-slate-200 p-4 rounded-xl overflow-x-auto hide-scrollbar text-sm font-mono shadow-inner">
        <code>{code}</code>
      </pre>
    </div>
  );
...
export default function DocsViewer() {
  ...
  const docSections = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white mb-6 tracking-tight">蜂群机场（fengqun.io）新手快速上手指南</h1>
          <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
            （建议顺序操作，先翻墙再注册购买更顺畅）
          </p>

          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">1. 安卓客户端下载（Clash for Android）</h2>
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            下载地址：<a href="https://一元机场.com/down/clash.apk" target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 hover:underline">https://一元机场.com/down/clash.apk</a>
          </p>
          <div className="glass-panel border-amber-200 dark:border-amber-500/20 rounded-xl p-4 mb-6">
            <p className="text-amber-800 dark:text-amber-300 text-sm">
              <strong>注意：</strong>可以先安装客户端、使用临时节点导入进去，打开VPN、在访问注册邀请链接购买稳定节点。
            </p>
          </div>

          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">2. 先使用临时节点快速翻墙</h2>
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            （免费测试用，适合新手先连上外网）
          </p>
          <div className="mb-4">
            <p className="font-medium text-slate-900 dark:text-white mb-2">订阅链接（直接复制导入）：</p>
            <CodeBlock code="https://sub3.smallstrawberry.com/api/v1/client/subscribe?token=facaba1f12f94dbe86a7c99d5e5d1b2d" />
          </div>
          
          <div className="glass-panel rounded-xl p-6 mb-6">
            <h3 className="font-bold text-slate-900 dark:text-white mb-3">导入方法：</h3>
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            <span className="text-indigo-600 dark:text-indigo-400">（clah安卓客户端节点导入图文教程)</span>、
            <span className="text-indigo-600 dark:text-indigo-400">（ clah安卓客户端使用图文教程）</span>
          </p>

          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">3. 翻墙成功后注册、购买稳定节点</h2>
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            邀请注册链接（需已翻墙访问）：<br />
            <a href="https://fengqun.io/#/register?code=f2UOFdta" target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 hover:underline break-all">
              https://fengqun.io/#/register?code=f2UOFdta
            </a>
          </p>
          ...
          <div className="glass-panel rounded-xl p-6 mb-6">
            <ol className="list-decimal list-inside space-y-2 text-slate-600 dark:text-slate-400">
              ...
              <li>充值购买套餐</li>
              <li>获取自己的专属长期订阅链接</li>
              <li>回到 Clash 客户端导入新订阅，替换临时节点，即可长期稳定使用</li>
            </ol>
          </div>

          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">温馨提示</h2>
          <ul className="list-disc list-inside space-y-2 text-slate-600 dark:text-slate-400 mb-6">
            <li>临时节点仅作过渡，速度/稳定性有限，建议尽早购买正式节点。</li>
            <li>遇到连接问题可重启客户端、切换节点，或查看机场官方公告。</li>
            <li>安全第一：只从可信来源下载APK，避免未知链接。</li>
          </ul>
          
          <p className="text-slate-600 dark:text-slate-400 mb-8 font-medium">
            这样一步步来基本不会卡住，新手友好度更高～有问题随时问！
          </p>

          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">相关资源下载</h2>
          <p className="text-slate-600 dark:text-slate-400 mb-4">
            {/* 预留下载压缩包的链接地方，请在这里替换链接 */}
            <a href="https://siusn-sisjxl.top/s/c3626d33c0243328a5b5bac35c7a74e7" target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 hover:underline break-all flex items-center gap-2">
              <ExternalLink className="w-4 h-4" />
              下载压缩包 (https://siusn-sisjxl.top/s/c3626d33c0243328a5b5bac35c7a74e7)
            </a>
          </p>

          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">启动网关</h2>
          <CodeBlock code="openclaw gateway --port 18789 --verbose" />
        </div>
      )
    },
    {
...
messages:
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            <div className="glass-panel p-6 rounded-xl shadow-sm dark:shadow-none">
  ...
  profiles:
    ...
    },
    {
      ...
      icon: Globe,
      content: (
        <div className="flex flex-col items-center justify-center flex-1 min-h-[600px] glass-panel p-8 text-center">
          <div className="w-20 h-20 glass-panel rounded-full flex items-center justify-center mb-6 border border-indigo-100 dark:border-indigo-500/20">
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-8 max-w-md leading-relaxed">
            由于官方文档网站的安全策略（如 X-Frame-Options）限制，无法在当前页面内嵌显示。请点击下方按钮在安全的新标签页中打开完整的官方文档。
          </p>
          <a 
            href="https://docs.openclaw.ai/zh-CN/" 
            target="_blank" 
            rel="noreferrer" 
            className="flex items-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-medium transition-colors shadow-sm"
          >
    ...
    },
    {
      ...
      icon: Globe,
      content: (
        <div className={`flex flex-col flex-1 w-full glass-panel ${isFullscreen ? 'fixed inset-0 z-50' : ''}`}>
          <div className="flex items-center justify-between px-4 md:px-6 py-3 shrink-0 border-b border-white/10 glass-panel z-10">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="https://openclaw.ai/" target="_blank" rel="noreferrer" className="flex items-center gap-1.5 text-sm text-indigo-600 dark:text-indigo-400 hover:underline glass-panel px-3 py-1.5 rounded-lg transition-colors">
                <ExternalLink className="w-4 h-4" /> <span className="hidden sm:inline">新标签页打开</span>
              </a>
            </div>
          </div>
          <iframe src="https://openclaw.ai/" className="flex-1 w-full border-none glass-panel" title="Official Website" />
        </div>
      )
    }
  ];
  ...
  return (
    <div className="flex-1 flex overflow-hidden h-full">
      ...
      <main className={`flex-1 flex flex-col overflow-y-auto transition-colors duration-300 ${
        activeSection.startsWith('official-') ? 'p-0 pt-16 lg:pt-0' : 'p-6 pt-16 lg:pt-6 md:p-12'
      }`}>
        <div className={`${activeSection.startsWith('official-') ? 'flex-1 w-full flex flex-col' : `mx-auto transition-all duration-300 ${(isPrimarySidebarCollapsed && isSidebarCollapsed) ? 'max-w-5xl 2xl:max-w-6xl' : 'max-w-4xl'}`}`}>
          {/* Mobile Breadcrumb */}
          ...
          <div className={`${
            activeSection.startsWith('official-') 
              ...
              : 'glass-panel p-8 md:p-12 rounded-2xl'
          }`}>

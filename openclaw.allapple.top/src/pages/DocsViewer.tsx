    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="bg-slate-100 dark:bg-white/5 rounded-xl p-6 mb-6">
  ...
  return (
    <div className="flex-1 flex overflow-hidden h-full">
      ...
      <main className={`flex-1 overflow-y-auto bg-slate-50 dark:bg-[#0A0A0B] transition-colors duration-300 ${
        ...
        <div className={`${activeSection.startsWith('official-') ? 'h-full w-full' : `mx-auto transition-all duration-300 ${(isPrimarySidebarCollapsed && isSidebarCollapsed) ? 'max-w-5xl 2xl:max-w-6xl' : 'max-w-4xl'}`}`}>
          {/* Mobile Breadcrumb */}

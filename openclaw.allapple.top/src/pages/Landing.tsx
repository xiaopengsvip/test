...
export default function Landing() {
  ...
  return (
    <PageTransition className="min-h-screen bg-slate-50 dark:bg-[#0A0A0B] text-slate-900 dark:text-slate-300 font-sans selection:bg-indigo-500/30 overflow-hidden transition-colors duration-300">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <motion.div 
              ...
              className="aspect-[9/16] w-full rounded-2xl overflow-hidden bg-slate-200 dark:bg-slate-800 shadow-lg"
            >
              <iframe 
      ...
      {/* ClawHub Section */}
      <section className="px-6 py-24 border-t border-slate-200 dark:border-white/10 bg-indigo-50/50 dark:bg-indigo-950/10 relative z-10 transition-colors overflow-hidden">
        <div className="max-w-6xl mx-auto relative">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="relative bg-white dark:bg-[#131316] border border-indigo-100 dark:border-indigo-500/20 rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row items-center gap-10 p-8 md:p-12 lg:p-16"
          >
            <div className="flex-1 text-center md:text-left z-10">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-100 dark:bg-indigo-500/20 text-xs font-semibold text-indigo-700 dark:text-indigo-300 mb-6">
                <span className="flex h-2 w-2 rounded-full bg-indigo-500 animate-pulse"></span>
                精英特工的技能平台
              </div>
              ...
              <button 
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold transition-all hover:-translate-y-1 shadow-lg shadow-indigo-500/30"
              >
      ...
      {/* Footer */}
      <footer className="py-12 border-t border-slate-200 dark:border-white/10 bg-white dark:bg-[#0A0A0B] relative z-10 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex flex-col items-center md:items-start gap-4">
              ...
              <div className="flex items-center gap-2 text-xs font-mono text-slate-400 dark:text-slate-500 bg-slate-100 dark:bg-white/5 px-3 py-1.5 rounded-full">

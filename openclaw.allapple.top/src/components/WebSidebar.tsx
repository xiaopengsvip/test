      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed inset-y-0 right-0 ${isFullscreen ? 'w-full' : 'w-[95vw] sm:w-[90vw] md:w-[80vw] lg:w-[70vw] xl:w-[60vw]'} bg-white dark:bg-[#0A0A0B] shadow-2xl z-50 flex flex-col border-l border-slate-200 dark:border-white/10 transition-[width,background-color,border-color] duration-300`}
          >
            {/* Header */}

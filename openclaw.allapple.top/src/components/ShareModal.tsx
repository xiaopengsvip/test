        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            <motion.div
              ...
              className="w-full max-w-md glass-panel rounded-2xl shadow-2xl border border-slate-200 dark:border-white/10 pointer-events-auto overflow-hidden flex flex-col"
            >
              {/* Header */}
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center">
                    <span className="px-3 glass-panel text-xs font-medium text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                      或复制链接
                    </span>
                  </div>
                </div>

                <div className="flex items-center gap-2 p-2 glass-panel border border-slate-200 dark:border-white/10 rounded-xl">
                  <div className="flex-1 px-3 py-2 text-sm text-slate-600 dark:text-slate-400 truncate font-mono bg-transparent outline-none">
                    {url}
                  </div>
                  <button
                    onClick={handleCopy}
                    className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium transition-colors shrink-0 glass-button ${
                      copied 
                ...
                {typeof navigator !== 'undefined' && navigator.share && (
                  <button
                    ...
                    className="w-full py-3 mt-2 flex items-center justify-center gap-2 text-sm font-medium text-slate-700 dark:text-slate-300 glass-button rounded-xl transition-colors"
                  >
